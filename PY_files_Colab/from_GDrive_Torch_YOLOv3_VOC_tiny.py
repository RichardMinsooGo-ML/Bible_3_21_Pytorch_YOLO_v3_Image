...
# VOC dataset download from Auther's Github repository
import gdown
google_path = 'https://drive.google.com/uc?id='
file_id = '1pq2LOUkRCbwp-rSD1lm5PI747pg5dDk_'
output_name = 'VOC_2012.zip'
gdown.download(google_path+file_id,output_name,quiet=False)
# https://drive.google.com/file/d/1pq2LOUkRCbwp-rSD1lm5PI747pg5dDk_/view?usp=sharing

!unzip /content/VOC_2012.zip -d /content/dataset/VOC2012
clear_output()
! rm /content/VOC_2012.zip
...
config = Config({
    ...
    "trained_path" : "/content/gdrive/MyDrive/Obj_detection_Torch_img/checkpoints/Yolo_V3_VOC_tiny.pth",
    "saved_path"   : "/content/gdrive/MyDrive/Obj_detection_Torch_img/checkpoints/Yolo_V3_VOC_tiny.pth",
#     "trained_path" : "/content/checkpoints/yolov3-tiny.weights",
#     "saved_path"   : "/content/checkpoints/Yolo_V3_VOC_tiny.pth",
    "working_dir"  : './',
    "num_epochs"   : 3,
    "batch_size"   : 8*4,
    "grad_accum"   : 2,
