...
class YoloLayer(nn.Module):
    ...
    def forward(self, x, targets):
        ...
        no_obj_mask=no_obj_mask.bool() #convert int8 to bool
...
class Darknet(nn.Module):
    def __init__(self, image_size: int, num_classes: int):
        ...
        self.yolo_layer3 = YoloLayer(anchors['scale3'], image_size, num_classes)
        ...
        self.yolo_layer2 = YoloLayer(anchors['scale2'], image_size, num_classes)
        ...
        self.yolo_layer1 = YoloLayer(anchors['scale1'], image_size, num_classes)
...
if __name__ == '__main__':
    model = Darknet(image_size=416, num_classes=80)
